...
+
Vederelink:../api/concept_element_api_about_the_api.html["Riferimento API software NetApp Element"] .
...
link:concept_system_manage_manage_ldap.html["Abilitare l'autenticazione LDAP con l'interfaccia utente Element"]
