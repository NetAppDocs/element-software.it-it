...
NOTE: Non modificare l'NTP dopo aver completato la configurazione della sincronizzazione dell'ora perché influisce sull'NTP quando si esegue il <<set-up-the-management-node,comando di installazione>> sul nodo di gestione.
