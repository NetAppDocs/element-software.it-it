...
* *Baseboard Management Controller (BMC) aggiornato per i nodi H610S*: È stata aggiornata la versione BMC per i nodi H610S. Vedere link:https://docs.netapp.com/us-en/hci/docs/rn_H610S_BMC_3.84.07.html["note di rilascio e istruzioni per l'aggiornamento"^].
