...
Se si esegue un aggiornamento sul posto di un nodo di gestione esistente a Element 12.9, prima di eseguire l'aggiornamento è necessario assicurarsi che la versione hardware della VM sul nodo di gestione sia compatibile con ESXi 6.7 (versione hardware della VM 14) o successiva, a seconda dell'ambiente.
