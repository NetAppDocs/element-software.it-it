...
+
image::vcp_remote_plugin_icons_home_page.png[Mostra i punti di estensione del plug-in dopo un aggiornamento o un'installazione riusciti per Element Plug-in 5.10 o versioni successive]
