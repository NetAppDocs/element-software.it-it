...
[NOTE]
====
* Questo metodo non attiva la crittografia software a riposo. Questa operazione può essere eseguita solo utilizzando link:../api/reference_element_api_createcluster.html["creare il metodo del cluster"^] con `enableSoftwareEncryptionAtRest` impostare su `true`.
