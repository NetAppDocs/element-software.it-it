...
summary: 'Il metodo GetNetworkConfig restituisce una risposta simile all"esempio seguente.' 
---
= GetNetworkConfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
Il `GetNetworkConfig` method restituisce una risposta simile all'esempio seguente.
