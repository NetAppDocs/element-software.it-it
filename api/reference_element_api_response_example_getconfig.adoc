...
summary: 'Il metodo GetConfig restituisce una risposta simile all"esempio seguente. A causa della lunghezza, la risposta contiene informazioni solo per un nodo del cluster.' 
---
= GetConfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
Il `GetConfig` method restituisce una risposta simile all'esempio seguente. A causa della lunghezza, la risposta contiene informazioni solo per un nodo del cluster.
