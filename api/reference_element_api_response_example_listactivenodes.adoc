...
summary: 'Il metodo ListActiveNodes restituisce una risposta simile all"esempio seguente.' 
---
= ListActiveNode
:allow-uri-read: 
:icons: font
...
[role="lead"]
Il `ListActiveNodes` method restituisce una risposta simile all'esempio seguente.
