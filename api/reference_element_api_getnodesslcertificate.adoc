...
summary: È possibile utilizzare il metodo GetNodeSSLCertificate per recuperare il certificato SSL attualmente attivo nel nodo di gestione. 
---
...
[role="lead"]
È possibile utilizzare `GetNodeSSLCertificate` Metodo per recuperare il certificato SSL attualmente attivo nel nodo di gestione.
