...
summary: È possibile utilizzare il metodo GetAPI per ottenere un elenco di tutti i metodi API e gli endpoint API supportati che possono essere utilizzati nel sistema. 
---
= GetAPI
:allow-uri-read: 
:icons: font
...
[role="lead"]
È possibile utilizzare `GetAPI` Metodo per ottenere un elenco di tutti i metodi API e gli endpoint API supportati che possono essere utilizzati nel sistema.
...
<version>
 a| 
Un elenco di tutti i metodi API supportati per questa versione del software, dove <version> è la versione corrente del software in esecuzione nel sistema.
 a| 
array di stringhe
...
CurrentVersion (versione attuale)
 a| 
La versione corrente del software del cluster di storage.
 a| 
stringa
...
SupportedVersioni
 a| 
Un elenco di tutti gli endpoint API supportati dal sistema.
 a| 
array di stringhe
