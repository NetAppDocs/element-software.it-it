...
summary: 'Il metodo GetNodeHardwareInfo per i nodi Fibre Channel restituisce una risposta simile all"esempio seguente.' 
---
= GetNodeHardwareInfo (output per nodi Fibre Channel)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Il `GetNodeHardwareInfo` Method for Fibre Channel Node restituisce una risposta simile all'esempio seguente.
