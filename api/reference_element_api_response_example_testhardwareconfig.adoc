...
summary: 'Il metodo TestHardwareConfig restituisce una risposta simile all"esempio seguente.' 
---
= TestHardwareConfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
Il `TestHardwareConfig` method restituisce una risposta simile all'esempio seguente.
