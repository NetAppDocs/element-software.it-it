...
summary: 'Il metodo GetNodeHardwareInfo per iSCSI restituisce una risposta simile all"esempio seguente.' 
---
= GetNodeHardwareInfo (output per iSCSI)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Il `GetNodeHardwareInfo` Method for iSCSI restituisce una risposta simile all'esempio seguente.
