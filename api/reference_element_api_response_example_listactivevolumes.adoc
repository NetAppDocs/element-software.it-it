...
summary: 'Il metodo ListActiveVolumes restituisce una risposta simile all"esempio seguente.' 
---
= ListActiveVolumes
:allow-uri-read: 
:icons: font
...
[role="lead"]
Il `ListActiveVolumes` method restituisce una risposta simile all'esempio seguente.
