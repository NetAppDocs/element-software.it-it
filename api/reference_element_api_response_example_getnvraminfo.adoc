...
summary: 'Il metodo GetNvramInfo restituisce una risposta simile all"esempio seguente.' 
---
= GetNvramInfo
:allow-uri-read: 
:icons: font
...
[role="lead"]
Il `GetNvramInfo` method restituisce una risposta simile all'esempio seguente.
