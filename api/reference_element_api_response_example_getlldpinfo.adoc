...
summary: 'Il metodo GetLldpInfo restituisce una risposta simile all"esempio seguente.' 
---
= GetLldpInfo
:allow-uri-read: 
:icons: font
...
[role="lead"]
Il `GetLldpInfo` method restituisce una risposta simile all'esempio seguente.
