...
* <<Configurare un nodo di storage utilizzando l'interfaccia utente per nodo,UI per nodo>>: Utilizza l'interfaccia utente per nodo (`https://<node_management_IP>:442`) per configurare le impostazioni di rete del nodo.
